...
description: Embedded engineer for ARM Cortex-M (STM32, NRF52, SAMD). Expert in firmware, drivers, DMA, and real-time optimization. Use for embedded systems and peripheral development.
risk: unknown
source: community
