...
description: Design and audit analytics tracking (GA4, GTM). Focuses on measurement strategy, signal quality, and reliable data for decisions. Use for setting up or fixing analytics instrumentation.
risk: unknown
source: community
