...
description: "Come usare antigravity-awesome-skills con Jetski/Cortex evitando l’overflow di contesto con 1.330+ skill."
---

# Jetski/Cortex + Gemini: integrazione sicura con 1.330+ skill
...
Con oltre 1.330 skill, questo approccio riempie il context window prima ancora di aggiungere i messaggi dell’utente, causando l’errore di truncation.
