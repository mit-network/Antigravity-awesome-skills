...
If the user asks to actually create or update one of the recommended skills, switch to [skill-creator](../skill-creator/SKILL.md) and implement the chosen skill rather than continuing the audit.
