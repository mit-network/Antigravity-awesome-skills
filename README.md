...
- **[chainstacklabs/pumpclaw](https://github.com/chainstacklabs/pumpclaw)**: Agent skill for pump.fun token trading on Solana via pumpfun-cli. Supports buying, selling, launching tokens, wallet management, dry-run simulation, slippage checks, and PumpSwap AMM migrations. Works with OpenClaw, Claude Code, Cursor, Codex, and Antigravity (Apache 2.0).
